...
export const LEGAL = {
  ...
  whatsappTip:
    "撞落去會開啟 WhatsApp 聯絡我哋（{phone}）。請勿分享銀行戶口或信用卡密碼。非電訊商官方客服。",
} as const;
...
export const FAQ = [
  ...
  {
    q: "公屋同埋居屋價錢會唔會唔同？",
    a: "公屋同埋居屋好多時有指定供應商同批量價，不過每個屋邨／屋苑合約都可能唔同。篩選時可以分開撿；問價記得填齊屋苑名稱。",
  },
  {
    q: "村屋有冇光纖？",
  ...
  {
    q: "點樣查核報價？",
    a: "最快用 WhatsApp 6309 9966。冇 WhatsApp 可以撞「留低電話」，填姓名同電話，我哋會致電你；亦可直接致電同一號碼，或電郵 info@chaiquote.hk。",
  },
] as const;

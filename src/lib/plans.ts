...
const PERK_SMARTONE_ADMIN = "每月行政費 HK$18";
const PERK_SMARTONE_ADMIN_WAIVED = "豁免每月行政費 HK$18";
const PERK_SMARTONE_REFER = "推薦人優惠";
const PERK_SMARTONE_AI = "免費 AI Connect+（AI 數據用量豁免）";
const PERK_SMARTONE_ASIA5 = "亞太區數據全日通 5 日";
const PERK_SMARTONE_SCREEN = "送 12 個月爆 Mon 保養";
const PERK_SMARTONE_PASS = "送 Smart Pass 快證";
const FUP_SMARTONE_1M = "其後以 1Mbps 無限任用";
const FUP_SMARTONE_2M = "其後以 2Mbps 無限任用";
const VOICE_SMARTONE = "無限本地通話";
const VOICE_SMARTONE_CN200 = "無限本地通話；中澳 200 分鐘";
const LIMITS_SMARTONE_MOBILE = "實際月費、數據用量及申請條款以電訊商確認為準。";
const LIMITS_SMARTONE_YOUTH =
  "適用於 18 至 29 歲客戶。實際月費、數據用量及申請資格以電訊商確認為準。";
const LIMITS_SMARTONE_FAMILY =
...
const PORT_CSL_36_1000 =
  "轉台可豁免每月行政費 HK$18；6 個月內轉台另享 HK$200 月費回贈；12 個月內轉台另享 HK$1,000 CSL 手機及智能家電禮券（須預繳 HK$500）";
...
export const PLANS: Plan[] = [
  ...
  },
  {
    ...
    housing: "all",
    network: "5G 無線",
    perks: ["計劃包含指定路由器", "7 日免費試用", "必須信用卡付款"],
    limits: `${LIMITS_HOME5G_SPEED}必須信用卡付款。`,
  ...
  {
    id: "cmhk-5g-limited-100-149",
    providerId: "cmhk",
    category: "mobile",
    name: "5G 限定 100GB（36 個月）",
    monthlyFee: 149,
    freeMonths: 6,
    contractMonths: 36,
    rebate: 400,
    ...
    housing: "all",
    network: "5G",
    perks: ["免 6 個月月費", "送 HK$400 月費回贈", "全中國及澳門數據 10GB", PERK_CMHK_ADMIN],
    portInPerk: PERK_CMHK_ADMIN_PORT,
    limits: LIMITS_CMHK_LIMITED,
    quotePick: true,
    latestOffer: true,
    bestFor: "適合需要 100GB 本地數據及中澳漫遊之用戶",
  },
  {
    id: "cmhk-5g-limited-60-98-youth",
    providerId: "cmhk",
    category: "mobile",
    name: "5G 限定 60GB（青年，24 個月）",
    monthlyFee: 98,
    freeMonths: 0,
    contractMonths: 24,
    rebate: 500,
    ...
    housing: "all",
    network: "5G",
    perks: ["適用於 18 至 29 歲", "送 HK$500 月費回贈", "全中國及澳門數據 3GB", PERK_CMHK_ADMIN],
    portInPerk: PERK_CMHK_ADMIN_PORT,
    limits: LIMITS_CMHK_YOUTH,
    quotePick: true,
    latestOffer: true,
    bestFor: "適合 18–29 歲、需要 60GB 本地數據及中澳漫遊之用戶",
  },
  {
    id: "cmhk-5g-limited-4places-50-149",
    providerId: "cmhk",
    category: "mobile",
    name: "5G 限定 4地共用 50GB（24 個月）",
    monthlyFee: 149,
    freeMonths: 0,
    contractMonths: 24,
    dataGb: 50,
    ...
    housing: "all",
    network: "5G",
    perks: ["4地共用數據 50GB", "送一卡兩號", PERK_CMHK_ADMIN],
    portInPerk: PERK_CMHK_ADMIN_PORT,
    limits: LIMITS_CMHK_LIMITED,
    quotePick: true,
    latestOffer: true,
    bestFor: "適合需要中港澳台 50GB 共用數據及一卡兩號之用戶",
  },
  {
    id: "cmhk-5g-limited-4places-50-209",
    providerId: "cmhk",
    category: "mobile",
    name: "5G 限定 4地共用 50GB（36 個月）",
    monthlyFee: 209,
    freeMonths: 6,
    contractMonths: 36,
    dataGb: 50,
    ...
    housing: "all",
    network: "5G",
    perks: ["免 6 個月月費", "4地共用數據 50GB", "送一卡兩號", PERK_CMHK_ADMIN],
    portInPerk: PERK_CMHK_ADMIN_PORT,
    limits: LIMITS_CMHK_LIMITED,
    quotePick: true,
    latestOffer: true,
  ...
  },
  {
    ...
    housing: "all",
    network: "5G",
    perks: [PERK_CSL_ADMIN, PERK_CSL_CLUB],
    portInPerk: PERK_CSL_ADMIN_PORT,
    bestFor: "適合需要 5G 30GB 及無限通話之用戶",
  },
  {
    id: "csl-5g-30-138-36m",
    providerId: "csl",
    category: "mobile",
    name: "5G 30GB（36 個月）",
    monthlyFee: 138,
    ...
    network: "5G",
    perks: [PERK_CSL_ADMIN, PERK_CSL_CLUB],
    portInPerk: PORT_CSL_36_800,
    bestFor: "適合需要 5G 30GB 及無限通話之用戶",
  },
  {
    id: "csl-5g-60-168-24m",
    providerId: "csl",
    category: "mobile",
    name: "5G 60GB（24 個月）",
    monthlyFee: 168,
    ...
    perks: [PERK_CSL_ADMIN, PERK_CSL_CLUB],
    portInPerk: PERK_CSL_ADMIN_PORT,
    bestFor: "適合需要 5G 60GB 及無限通話之用戶",
  },
  {
    id: "csl-5g-60-168-36m",
    providerId: "csl",
    category: "mobile",
    name: "5G 60GB（36 個月）",
    monthlyFee: 168,
    ...
    network: "5G",
    perks: [PERK_CSL_ADMIN, PERK_CSL_CLUB],
    portInPerk: PORT_CSL_36_1000,
    bestFor: "適合需要 5G 60GB 及無限通話之用戶",
  },
  {
    id: "csl-5g-100-198-24m",
    providerId: "csl",
    category: "mobile",
    name: "5G 100GB（24 個月）",
    monthlyFee: 198,
    ...
    perks: [PERK_CSL_ADMIN, PERK_CSL_CLUB],
    portInPerk: PERK_CSL_ADMIN_PORT,
    bestFor: "適合需要 5G 100GB 及無限通話之用戶",
  },
  {
    id: "csl-5g-100-198-36m",
    providerId: "csl",
    category: "mobile",
    name: "5G 100GB（36 個月）",
    monthlyFee: 198,
  ...
  {
    id: "smartone-45g-15-79",
    providerId: "smartone",
    category: "mobile",
    name: "4.5G 無限數據（15GB，30 個月）",
    monthlyFee: 79,
    freeMonths: 0,
    contractMonths: 30,
    dataGb: 15,
    highSpeedGb: 15,
    fupNote: FUP_SMARTONE_2M,
    voice: VOICE_SMARTONE,
    roaming: "每月 1GB 中國內地及澳門數據",
    install: "不適用",
    housing: "all",
    network: "4.5G",
    perks: [PERK_SMARTONE_ADMIN_WAIVED, PERK_SMARTONE_REFER],
    limits: LIMITS_SMARTONE_MOBILE,
    bestFor: "適合輕量上網、需要無限本地通話之用戶",
  },
  {
    id: "smartone-5g-youth-60-98",
    providerId: "smartone",
    category: "mobile",
    name: "5G 18–29 歲青年計劃 60GB（36 個月）",
    monthlyFee: 98,
    freeMonths: 0,
    contractMonths: 36,
    dataGb: 60,
    highSpeedGb: 60,
    fupNote: FUP_SMARTONE_1M,
    voice: VOICE_SMARTONE,
    roaming: "每月 3GB 中國內地及澳門數據",
    install: "不適用",
    housing: "all",
    network: "5G",
    perks: ["適用於 18 至 29 歲", PERK_SMARTONE_ASIA5, PERK_SMARTONE_AI, PERK_SMARTONE_ADMIN_WAIVED, PERK_SMARTONE_REFER],
    limits: LIMITS_SMARTONE_YOUTH,
    bestFor: "適合 18 至 29 歲、需要 5G 60GB 之用戶",
  },
  {
    id: "smartone-45g-42m-100",
    providerId: "smartone",
    category: "mobile",
    name: "4.5G 42Mbps 無限數據（30 個月）",
    monthlyFee: 100,
    freeMonths: 0,
    contractMonths: 30,
    fupNote: "42Mbps 無限任用",
    ...
    housing: "all",
    network: "4.5G",
    perks: ["無限本地數據（42Mbps）", PERK_SMARTONE_ADMIN_WAIVED, PERK_SMARTONE_REFER],
    limits: LIMITS_SMARTONE_MOBILE,
    bestFor: "適合需要 4.5G 無限數據及無限本地通話之用戶",
  },
  {
    id: "smartone-5g-youth-120-138",
    providerId: "smartone",
    category: "mobile",
    name: "5G 18–29 歲青年計劃 120GB（36 個月）",
    monthlyFee: 138,
    freeMonths: 0,
    contractMonths: 36,
    dataGb: 120,
    ...
    perks: ["適用於 18 至 29 歲", PERK_SMARTONE_ASIA5, PERK_SMARTONE_AI, PERK_SMARTONE_ADMIN_WAIVED, PERK_SMARTONE_REFER],
    limits: LIMITS_SMARTONE_YOUTH,
    bestFor: "適合 18 至 29 歲、需要 5G 120GB 之用戶",
  },
  {
    id: "smartone-5g-handset-30-139",
    providerId: "smartone",
    category: "mobile",
    name: "5G 出機上台 30GB（30 個月）",
    monthlyFee: 139,
    freeMonths: 0,
    contractMonths: 30,
    dataGb: 30,
    ...
    housing: "all",
    network: "5G",
    perks: ["送 HK$1,400 買機禮券", PERK_SMARTONE_SCREEN, PERK_SMARTONE_PASS, PERK_SMARTONE_ADMIN, PERK_SMARTONE_REFER],
    limits: LIMITS_SMARTONE_HANDSET,
    bestFor: "適合需要換機優惠及 5G 30GB 之用戶",
  },
  {
    id: "smartone-5g-handset-60-179",
    providerId: "smartone",
    category: "mobile",
    name: "5G 出機上台 60GB（30 個月）",
    monthlyFee: 179,
    freeMonths: 0,
    contractMonths: 30,
    dataGb: 60,
    ...
    housing: "all",
    network: "5G",
    perks: ["送 HK$1,700 買機禮券", PERK_SMARTONE_SCREEN, PERK_SMARTONE_PASS, PERK_SMARTONE_ADMIN, PERK_SMARTONE_REFER],
    limits: LIMITS_SMARTONE_HANDSET,
    bestFor: "適合需要換機優惠及 5G 60GB 之用戶",
  },
  {
    id: "smartone-5g-110-234",
    providerId: "smartone",
    category: "mobile",
    name: "5G 無限數據 110GB（36 個月）",
    monthlyFee: 234,
    freeMonths: 0,
    contractMonths: 36,
    dataGb: 110,
    highSpeedGb: 110,
    fupNote: FUP_SMARTONE_1M,
    voice: VOICE_SMARTONE_CN200,
    roaming: "每月 10GB 中國內地及澳門數據",
    install: "不適用",
    housing: "all",
    network: "5G",
    perks: [PERK_SMARTONE_ADMIN_WAIVED, PERK_SMARTONE_REFER],
    limits: LIMITS_SMARTONE_MOBILE,
    bestFor: "適合高本地數據用量、需要中澳通話之用戶",
  },
  {
    id: "smartone-5g-handset-110-239",
    providerId: "smartone",
    category: "mobile",
    name: "5G 出機上台 110GB（30 個月）",
    monthlyFee: 239,
    freeMonths: 0,
    contractMonths: 30,
    dataGb: 110,
    ...
    limits: LIMITS_SMARTONE_HANDSET,
    bestFor: "適合需要換機優惠及 5G 110GB 之用戶",
  },
  {
    id: "smartone-5g-handset-110-299",
    providerId: "smartone",
    category: "mobile",
    name: "5G 出機上台 110GB 連中澳通話（30 個月）",
    monthlyFee: 299,
    freeMonths: 0,
    contractMonths: 30,
    dataGb: 110,
    ...
    housing: "all",
    network: "5G",
    perks: ["送 HK$2,200 買機禮券", PERK_SMARTONE_SCREEN, PERK_SMARTONE_PASS, PERK_SMARTONE_ADMIN, PERK_SMARTONE_REFER],
    limits: LIMITS_SMARTONE_HANDSET,
    bestFor: "適合需要換機優惠、110GB 及中澳通話之用戶",
  },
  {
    id: "smartone-5g-family-2-309",
    providerId: "smartone",
    category: "mobile",
    name: "5G 家庭共享 2 卡 110GB（36 個月）",
    monthlyFee: 309,
    freeMonths: 0,
    contractMonths: 36,
    dataGb: 110,
    ...
    housing: "all",
    network: "5G",
    perks: ["2 張 SIM 卡共享 110GB", "送 HK$500 買機及配件禮券", PERK_SMARTONE_ADMIN_WAIVED, PERK_SMARTONE_REFER],
    limits: LIMITS_SMARTONE_FAMILY,
    bestFor: "適合兩人共用 5G 數據之家庭",
  },
  {
    id: "smartone-5g-handset-180-399",
    providerId: "smartone",
    category: "mobile",
    name: "5G 出機上台 180GB（30 個月）",
    monthlyFee: 399,
    freeMonths: 0,
    contractMonths: 30,
    dataGb: 180,
    ...
    fupNote: FUP_SMARTONE_1M,
    voice: VOICE_SMARTONE_CN200,
    roaming: "每月 15GB 中國內地及澳門數據",
    install: "不適用",
    housing: "all",
    network: "5G",
    perks: ["送 HK$3,200 買機禮券", PERK_SMARTONE_SCREEN, PERK_SMARTONE_PASS, PERK_SMARTONE_ADMIN, PERK_SMARTONE_REFER],
    limits: LIMITS_SMARTONE_HANDSET,
    bestFor: "適合需要換機優惠及高數據用量之用戶",
  },
  {
    id: "smartone-5g-family-3-414",
    providerId: "smartone",
    category: "mobile",
    name: "5G 家庭共享 3 卡 110GB（36 個月）",
    monthlyFee: 414,
    freeMonths: 0,
    contractMonths: 36,
    dataGb: 110,
    ...
    housing: "all",
    network: "5G",
    perks: ["3 張 SIM 卡共享 110GB", "送 HK$1,000 買機及配件禮券", PERK_SMARTONE_ADMIN_WAIVED, PERK_SMARTONE_REFER],
    limits: LIMITS_SMARTONE_FAMILY,
    bestFor: "適合三人共用 5G 數據之家庭",
  },
  {
    id: "smartone-5g-family-4-519",
    providerId: "smartone",
    category: "mobile",
    name: "5G 家庭共享 4 卡 110GB（36 個月）",
    monthlyFee: 519,
    freeMonths: 0,
    contractMonths: 36,
    dataGb: 110,
    ...
    housing: "all",
    network: "5G",
    perks: ["4 張 SIM 卡共享 110GB", "送 HK$1,500 買機及配件禮券", PERK_SMARTONE_ADMIN_WAIVED, PERK_SMARTONE_REFER],
    limits: LIMITS_SMARTONE_FAMILY,
    bestFor: "適合四人共用 5G 數據之家庭",
  },
  {
    id: "smartone-5g-family-5-624",
    providerId: "smartone",
    category: "mobile",
    name: "5G 家庭共享 5 卡 110GB（36 個月）",
    monthlyFee: 624,
    freeMonths: 0,
    contractMonths: 36,
    dataGb: 110,
    ...
    housing: "all",
    network: "5G",
    perks: ["5 張 SIM 卡共享 110GB", "送 HK$2,000 買機及配件禮券", PERK_SMARTONE_ADMIN_WAIVED, PERK_SMARTONE_REFER],
    limits: LIMITS_SMARTONE_FAMILY,
    bestFor: "適合五人共用 5G 數據之家庭",
  },
  {
    id: "hkbn-45g-10",
    providerId: "hkbn",
  ...
  },
  {
    ...
    providerId: "hkbn",
    category: "mobile",
    name: "5G 100GB + 8GB（24 個月）",
    monthlyFee: 128,
    freeMonths: 0,
    contractMonths: 24,
    dataGb: 100,
    highSpeedGb: 100,
    fupNote: "其後不高於 1Mbps 任用",
    voice: "本地 3,000 分鐘",
    roaming: "每月 8GB 中國內地及澳門數據",
    install: "不適用",
    housing: "all",
    network: "5G",
    perks: [
    ...
    portInPerk: PERK_HKBN_PORT,
    limits: "此流動通訊計劃使用 3香港網絡。客戶須承諾最短合約期 24 個月。所有優惠及服務受條款及細則約束。",
    bestFor: "適合高本地數據用量，以及需要內地及澳門數據之用戶",
  },
  {
    id: "hkbn-5g-100-148",
    providerId: "hkbn",
  ...
  },
  {
    ...
    dataGb: 70,
    highSpeedGb: 70,
    fupNote: "其後不高於 1Mbps 任用香港本地流動數據",

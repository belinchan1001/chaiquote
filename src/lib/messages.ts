...
export const MESSAGES = {
  zh: {
    ...
    featuredTitle: "入門價一覽",
    featuredLead: "四條常見起步計劃。覆蓋同月費申請時再確認。",
    seeAllPlans: "睇晒所有計劃",
    ...
    faq2q: "公屋同居屋價錢會唔會唔同？",
    faq2a:
      "公屋同居屋好多時有指定供應商同批量價，不過每個屋邨／屋苑合約都可能唔同。篩選時可以分開揀；問價時請填齊屋苑名稱。",
    faq3q: "村屋有冇光纖？",
    faq3a:
  ...
  en: {
    ...
    estatesNewIntakeLead: "Recently occupied or soon-to-move-in estates, already in address search.",

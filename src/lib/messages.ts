...
export const MESSAGES = {
  zh: {
    ...
    estatesShowDistrict: "睇晒{district}（{n}）",
    estatesPreviewNote: "每個地區先顯示部分屋苑，揀地區或撳睇晒就會出齊。",
    allDistricts: "全部地區",
  ...
  en: {
    ...
    estatesShowDistrict: "See all {district} ({n})",
    estatesPreviewNote: "Each district shows a preview. Pick a district or tap see-all to load the rest.",

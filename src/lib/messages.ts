...
export const MESSAGES = {
  zh: {
    ...
    aiWelcome:
      "你好，我係齊Quote AI 篩選。可以幫你篩站內參考計劃，或者答光纖、5G 家居、手機、村屋、轉台呢類一般問題。價錢只顯示喺卡片。",
  ...
  en: {
    ...
    aiWelcome:
      "Hi, I am ChaiQuote AI filter. I can filter reference plans on this site, or answer general questions on fibre, 5G home, mobile, village houses and port-in. Fees stay on the cards.",

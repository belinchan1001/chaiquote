...
export const MESSAGES = {
  zh: {
    ...
    offerMintLead: "每次客人問先產生一條新連結。將新連結傳俾客人；客人撳入睇完之後，條連結會失效。唔好傳呢頁本身。",
    offerMintMake: "產生連結",
  ...
  en: {
    ...
    offerMintLead: "Create a new link each time a customer asks. Send that link — after they open it, it stops working. Do not send this page.",

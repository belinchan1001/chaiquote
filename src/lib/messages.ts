...
export const MESSAGES = {
  zh: {
    ...
    aiStaff: "AI 專員",
    aiStaffShort: "AI",
    aiStaffLead: "幫你篩計劃，亦可以答一般問題",
    aiWelcome:
      "你好，我係齊Quote AI 專員。可以幫你篩站內參考計劃，或者答光纖、5G 家居、手機、村屋、轉台呢類一般問題。價錢只顯示喺卡片。",
    ...
    aiHint: "例如「天耀邨 1000M」或者「村屋有冇光纖」。價錢喺卡片，唔會由 AI 報價。",
    aiThinking: "幫你睇緊…",
    aiSeePlan: "睇計劃卡",
  ...
  en: {
    ...
    waHeaderShort: "WhatsApp",
    aiStaff: "AI specialist",
    aiStaffShort: "AI",
    aiStaffLead: "Filters plans and answers general questions",
    aiWelcome:
      "Hi, I am the ChaiQuote AI specialist. I can filter reference plans on this site, or answer general questions on fibre, 5G home, mobile, village houses and port-in. Fees stay on the cards.",
    aiDraft: "Estate, 1000M or mobile…",
    aiClose: "Close AI specialist",
    ...
    aiHint: "Try “Tin Yiu Estate 1000M” or “Can village houses get fibre?” Fees stay on the cards — the AI will not quote prices.",

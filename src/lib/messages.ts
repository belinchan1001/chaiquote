...
export const MESSAGES = {
  zh: {
    ...
    plansNetvigatorOnlyNote: "此屋苑暫時只列出網上行光纖，以及 5G 家居寬頻作參考。實際覆蓋以電訊商確認為準。",
    ...
    offerMintTitle: "產生一次有效連結",
    offerMintLead: "每次客人問先產生一條新連結。將新連結傳俾客人，唔好自己打開嚟試，亦唔好傳呢頁本身。客人撳入會即睇計劃。",
    offerMintMake: "產生連結",
    offerMintAgain: "再產生一條",
    offerMintMakePlan: "產生 {plan} 連結",
    offerMintAgainPlan: "再產生 {plan} 連結",
    offerMintCopy: "複製連結",
    offerMintReady: "將下面呢條傳俾客人。唔好傳而家呢頁嘅網址。",
    offerMintFail: "而家產生唔到連結，請再試一次。",
    offerMintSend: "用 WhatsApp 傳俾客人",
    offerOpenTitle: "睇計劃",
    offerOpenLead: "撳下面睇計劃。此頁僅供你參考。",
    offerOpen: "顯示計劃",
    offerUsedTitle: "連結已失效",
    offerUsedLead: "此連結已經用過或無效。如需查核報價，請 WhatsApp 聯絡。",
    searchKeyword: "計劃關鍵字",
    moreFilters: "更多篩選",
    providers: "網絡供應商",
    loadMore: "再睇多啲",
  ...
  en: {
    ...
    offerMintTitle: "Create a one-time link",
    offerMintLead: "Create a new link for each customer. Send that link — do not open it yourself, and do not send this page. The customer sees the plans on open.",
    offerMintMake: "Create link",
    offerMintAgain: "Create another",
    offerMintMakePlan: "Create {plan} link",
    offerMintAgainPlan: "Create another {plan} link",
    offerMintCopy: "Copy link",
    offerMintReady: "Send the link below to the customer. Do not send this page’s URL.",
    offerMintFail: "Could not create a link. Please try again.",
    offerMintSend: "Send on WhatsApp",
    offerOpenTitle: "View plan",
    offerOpenLead: "Tap below to view the plan. This page is for your reference only.",
    offerOpen: "Show plan",
    offerUsedTitle: "Link expired",
    offerUsedLead: "This link has already been used or is invalid. WhatsApp us to check the quote.",

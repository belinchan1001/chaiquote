...
export const MESSAGES = {
  zh: {
    ...
    bestPicksLead: "每個服務類型，喺本站現有參考計劃入面揀月費較低嘅一條。唔代表全港最平，實際以電訊商確認為準。",
    bestPicksCta: "睇計劃",
    ...
    plansNetvigatorOnlyNote: "呢個屋苑暫時只列出網上行光纖，同埋 5G 家居寬頻作參考。實際覆蓋以電訊商確認為準。",
    ...
    aboutWho: "我們是誰",
    aboutWhoText:
      "齊Quote 是香港獨立電訊比較平台，將家居寬頻、5G 家居及手機月費集中一處，公開、中立，不代任何一間電訊商發言。",
    aboutWhy: "我們的理念",
    aboutWhyText:
      "市面上合約條款與隱藏收費繁雜。我們整理各大營運商最新方案，讓你用最短時間選到符合預算與需要的計劃。",
    ...
    faq1a:
      "唔係。我哋係獨立比較網站，將公開渠道同市場常見優惠集中一處。最終月費、覆蓋同安裝期，都以電訊商確認為準。",
    faq2q: "公屋同居屋價錢會唔會唔同？",
    faq2a:
      "公屋同埋居屋好多時有指定供應商同批量價，不過每個屋邨／屋苑合約都可能唔同。篩選時可以分開揀；問價時請填齊屋苑名稱。",
    faq3q: "村屋有冇光纖？",
    faq3a:
      "村屋光纖而家主要由香港寬頻、HGC 同網上行提供指定計劃；公屋、居屋同私樓計劃一般唔適用。未有光纖嘅地址，可以一併比較 5G 家居寬頻。實際覆蓋要核對門牌。",
    faq4q: "商業寬頻同家居計劃有咩分別？",
    faq4a:
    ...
    privacyCollectText: "姓名同電話（經「留低電話」表格）、WhatsApp 或電話聯絡資料，以及一般瀏覽技術資料。",
    privacyUse: "用嚟做咩",
    privacyUseText: "用嚟回覆查詢、提供計劃參考同跟進、改善網站，以及在法律要求下配合。",
    ...
    privacyRights: "你嘅權利",
    privacyRightsText: "你可要求查閱或改正個人資料，聯絡渠道同上。",
    privacyUpdate: "更新",
    ...
    quoteEmailPending: "電郵尚未接上。等唔切請直接致電或 WhatsApp {phone}。",
    ...
    compareNoneLead: "喺計劃度撳「比較」，最多可以對 3 個計劃。",
    seePlans: "去睇計劃",
    backToPlans: "返回計劃表",
    compareN: "比較 {n} 個計劃",
    compareSwipe: "左右滑動比較",
    ...
    readGuide: "睇攻略",
    orReadGuide: "或睇攻略文章",
    guidesIndexH1: "點揀光纖、5G家居、手機同商業寬頻",
    guidesIndexLead: "四個分類下面係全部攻略。月費同安裝以電訊商確認為準。",
    quoteMobile: "手提電話",
    providerCount: "{name}，{n} 個計劃",
    logoSee: "標誌用法見",
    dash: "—",
    villageNoteEnd: "。",
    pwaInstallHeading: "加到主畫面／安裝",
    errorTitle: "呢頁暫時出咗問題",
  ...
  en: {
    ...
    featuredLead: "Four common starter plans. Coverage and fees are confirmed by the carrier when you apply.",
    ...
    estatesIndexCount: "{n} estates in the same catalogue as homepage search",
    ...
    estatesNewIntakeLead: "Recently occupied or incoming estates, aligned with the address search catalogue.",
    ...
    aboutWho: "Who we are",
    aboutWhoText:
      "ChaiQuote is an independent Hong Kong telecom comparison site. We list home fibre, 5G home and mobile plans in one place, openly and without speaking for any carrier.",
    aboutWhy: "What we do",
    aboutWhyText:
      "Contracts and hidden fees are messy. We organise current offers so you can pick a plan that fits your budget and needs in minutes.",
    ...
    faq1a:
      "No. This is an independent comparison site. We put public offers and common market deals in one place. Final fees, coverage and install dates are confirmed by the carrier.",
    ...
    guideCta: "Ready? Compare real plans next.",
    ...
    guidesIndexLead: "Every guide sits under these four topics. Fees and install are confirmed by the carrier.",
    quoteMobile: "Mobile number",
    providerCount: "{name}, {n} plans",
    logoSee: "Logo usage:",
    dash: "—",
    villageNoteEnd: ".",
    pwaInstallHeading: "Add to home screen",

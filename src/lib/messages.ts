...
export const MESSAGES = {
  zh: {
    ...
    aiStaff: "AI 專員",
    aiStaffShort: "AI",
    aiStaffLead: "只揀站內參考卡，唔報月費",
    aiWelcome: "你好，我係齊Quote AI 專員。講屋苑或想要光纖／手機，我會揀站內參考卡。",
    ...
    aiHint: "打字問屋苑或計劃，我會揀站內參考卡。月費只顯示喺卡片，唔會由 AI 報價。",
    aiThinking: "幫你對緊計劃…",
    aiSeePlan: "睇計劃卡",
  ...
  en: {
    ...
    aiStaffShort: "AI",
    aiStaffLead: "Picks reference cards only. Does not quote fees",
    aiWelcome: "Hi, I am the ChaiQuote AI specialist. Tell me the estate, fibre or mobile plan you need, and I will pick reference cards from this site.",
    ...
    aiHint: "Type an estate or plan. I only pick reference cards from this site. Fees stay on the cards — the AI will not quote prices.",
    aiThinking: "Matching plans…",

...
export const MESSAGES = {
  zh: {
    ...
    quoteEmailPending: "如果表格未能電郵，等唔切請直接致電或 WhatsApp {phone}，或電郵 {email}。",
    ...
    guidesIndexLead: "下面四個分類就係全部攻略。月費同安裝以電訊商確認為準。",
    quoteMobile: "手提電話",
  ...
  en: {
    ...
    guidesIndexLead: "All guides sit under these four topics. Fees and install are confirmed by the carrier.",

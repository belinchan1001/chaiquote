  ...
  },
  {
    ...
    body: [
      ...
      },
      {
        heading: "村屋光纖唔係公屋價",
        paragraphs: [
          "公屋／居屋有時有指定批量計劃；村屋多數係另一批報價，月費、安裝費、安裝期都可以唔同。齊Quote 分開列出參考，例子見 [村屋光纖參考月費](/guides/village-fees)，唔好用屋邨價去估丁屋。",
        ],
      },
      {
        heading: "可能要現場",
        paragraphs: [
          "拉線路徑、井蓋、天台機位，網上相睇唔晒。需要就約 [實地視察同現場測 5G](/guides/village-onsite)，再決定主用光纖定 5G 家居。",

...
export function chipClass(selected: boolean) {
  return cn(
    "chip-press inline-flex h-11 min-w-11 items-center justify-center rounded-full px-3 text-sm font-medium transition-[background-color,color] duration-150 ease-out",
